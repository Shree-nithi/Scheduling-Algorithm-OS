  ...
  **************************************************/
  ...
  (function ($) {
    ...
    function createNewSlider(element, options) {
      ...
      this.sliderElem.addEventListener("mousedown", this.mousedown, false); // Bind tooltip-related handlers
    ...
    Slider.prototype = {
      ...
      setValue: function setValue(val, triggerSlideEvent) {
        if (!val) {
          val = 0;
        }
      ...
      _removeSliderEventHandlers: function _removeSliderEventHandlers() {
        ...
        this.handle1.removeEventListener("blur", this.hideTooltip, false); // Remove event listeners from handle2

        this.handle2.removeEventListener("keydown", this.handle2Keydown, false);
        this.handle2.removeEventListener("focus", this.handle2Keydown, false);
        this.handle2.removeEventListener("blur", this.handle2Keydown, false); // Remove event listeners from sliderElem
      ...
      */
      _getPercentage: function _getPercentage(ev) {
        ...
        var distanceToSlide = eventPosition - sliderOffset; // Calculate what percent of the length the slider handle has slid

        var percentage = distanceToSlide / this.size * 100;
        percentage = Math.round(percentage / this.percentage[2]) * this.percentage[2]; // Make sure the percent is within the bounds of the slider.
...
//# sourceMappingURL=bootstrap-slider.dev.js.map
